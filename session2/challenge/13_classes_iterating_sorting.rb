...
=begin
1. Creae class called User.
2. initializ method with @username.
3. Create a method add_blog which adds a date and text.
3. Create a method called blogs which returns an array of all blogs in reverse chrononlogical order.
=end
